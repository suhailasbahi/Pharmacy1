// lib/modules/pharmacy/screens/suppliers_screen.dart
...
class _SuppliersScreenState extends State<SuppliersScreen> {
  ...
  Future<void> _loadSuppliers() async {
    ...
    try {
      ...
      await provider.loadSuppliersForPharmacy(widget.pharmacyId);
    } catch (e) {
      ...
      builder: (context, provider, child) {
        if (provider.isLoading || _isLoading) {
          return const Scaffold(
            appBar: AppBar(title: Text('حسابات الموردين'), centerTitle: true),
        ...
        if (provider.error != null) {
          return Scaffold(
            appBar: AppBar(title: const Text('حسابات الموردين'), centerTitle: true),
            body: ErrorWidget(
        ...
        final suppliers = provider.getFilteredSuppliers(_searchQuery);
        final totalBalance = provider.getTotalSuppliersBalance(searchQuery: _searchQuery);
        ...
        if (suppliers.isEmpty) {
          return Scaffold(
            ...
            body: const EmptyWidget(
              title: 'لا توجد حسابات موردين',
              subtitle: 'سيظهر الموردين هنا بعد إتمام أول طلب',
  ...
  Widget _buildSupplierCard(SupplierAccount supplier, AccountProvider provider) {
    return FutureBuilder<double>(
      future: provider.getSupplierBalance(supplier.id),
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            supplier.phone.isEmpty ? 'بدون رقم' : supplier.phone,
                          ...
                          await Navigator.push(
                            ...
                            MaterialPageRoute(
                              builder: (_) => AddPaymentScreen(
                                ...
                                accountCurrency: supplier.currency,
                              ),
                            ),
                          );
                          _loadSuppliers();
