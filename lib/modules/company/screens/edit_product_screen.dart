// lib/modules/company/screens/edit_product_screen.dart
import 'dart:io';
...
class _EditProductScreenState extends State<EditProductScreen> {
  ...
  void _updateProduct() async {
    ...
    try {
      ...
      if (mounted) {
        SnackBarService.showSuccess('تم تعديل المنتج بنجاح');
        ...
        children: [
          ListTile(
            ...
            subtitle: TextFormField(
              initialValue: _bonusCash?.percentage.toString(),
              keyboardType: TextInputType.number,
              decoration: const InputDecoration(
          ...
          ListTile(
            ...
            subtitle: TextFormField(
              initialValue: _bonusCredit?.percentage.toString(),
              keyboardType: TextInputType.number,
              decoration: const InputDecoration(
