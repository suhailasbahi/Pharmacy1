// lib/modules/company/screens/customer_statement_screen.dart
...
class _CustomerStatementScreenState extends State<CustomerStatementScreen> {
  ...
  Future<void> _loadData() async {
    ...
    try {
      ...
      var transactions = await accountProvider.getRunningBalance(widget.customer.id);
          ...
          await Navigator.push(
            ...
            MaterialPageRoute(
              builder: (_) => AddPaymentScreen(
                ...
                accountCurrency: widget.customer.currency,
              ),
            ),
          );
          _loadData();
